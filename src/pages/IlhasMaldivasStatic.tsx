...
const RESORTS_DATA: PackageData[] = [
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Surf", "Famílias", "All-inclusive"],
    transfer: "30 min speedboat",
    unique: "Acesso exclusivo ao surf break Lohis",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Luxury sustentável", "Casais", "Famílias"],
    transfer: "35 min hidroavião",
    unique: "Villa na copa das árvores",
  ...
  },
  {
    ...
    rating: "5 estrelas",
    duration: "4 noites",
    meals: "Meia pensão (café da manhã e jantar)",
    tags: ["Famílias", "Casais", "Atividades aquáticas"],
    transfer: "30 min speedboat (24h)",
    unique: "Acesso a 3 ilhas Anantara com transfer gratuito",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "Meia pensão (café da manhã e jantar)",
    tags: ["Ultra-luxury", "Casais", "Gastronomia"],
    transfer: "35 min hidroavião",
    unique: "Restaurante SEA subaquático + observatório SKY",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Luxury", "Casais", "Spa wellness"],
    transfer: "55-75 min voo + 25-50 min speedboat",
    unique: "Hammam turco + jardim orgânico próprio",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "Café da manhã",
    tags: ["Ultra-luxury exclusivo", "Casais VIP"],
    transfer: "40 min hidroavião privativo",
    unique: "Único resort LVMH",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Wellness & Spa", "Privacidade máxima"],
    transfer: "60 min hidroavião",
    unique: "Shambhala Retreat",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Gastronomia", "Casais", "Luxury clássico"],
    transfer: "30 min hidroavião",
    unique: "Ithaa primeiro restaurante subaquático + suíte Muraka",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Deluxe All-Inclusive", "Famílias", "Sustentabilidade"],
    transfer: "40 min hidroavião ou 30 min voo + 15 min speedboat",
    unique: "Melhor All-Inclusive Mundo 2024 + Kids Club 1.500m²",
  ...
  },
  {
    ...
    duration: "4 noites",
    meals: "All inclusive",
    tags: ["Deluxe All-Inclusive", "Casais", "Famílias", "Mergulho", "Recife próprio"],
    transfer: "45 min hidroavião ou 40 min voo doméstico + 5 min speedboat",
    unique: "Recife próprio de 9km",
