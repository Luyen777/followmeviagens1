...
const IlhasMaldivasStatic = () => {
  ...
  const itemListSchema = createItemListSchema(resorts.map(resort => ({
    name: resort.title,
  ...
  return <>
      <SEOHead title="Pacotes para Maldivas 2025 | Resorts de Luxo | Follow Me Viagens" description="Descubra as Ilhas Maldivas - o paraíso do Oceano Índico. 49 resorts de luxo, overwater villas exclusivas, mergulho espetacular e experiências inesquecíveis. Pacotes all-inclusive personalizados." canonicalUrl="/ilhas-maldivas-static" keywords={["maldivas", "pacotes maldivas", "resorts maldivas", "viagem maldivas", "lua de mel maldivas", "overwater villas", "ilhas maldivas"]} structuredData={itemListSchema} />
      ...
      <main className="min-h-screen bg-background">
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 container mx-auto px-4 py-24 text-center">
            ...
            <p className="text-xl md:text-2xl text-white/90 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{
            animationDelay: '0.2s'
          }}>
        ...
        <section className="py-32 sm:py-44 relative overflow-hidden bg-gradient-to-b from-[#0a0d1f] via-[#0d1220] to-[#0a0d1f]">
          ...
          <div className="container mx-auto relative z-10 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-6 max-w-6xl mx-auto mb-20">
              {["Agência especializada nas Ilhas Maldivas", "Parcerias diretas com os melhores resorts", "Melhores preços garantidos", "Pacotes all-inclusive personalizados", "Atendimento em português 24/7", "Suporte completo antes, durante e após a viagem"].map((benefit, index) => <div key={index} className="flex items-start gap-4 group">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-20">
              ...
              return <div key={index} className="group text-center">
