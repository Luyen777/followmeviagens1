        ...
        <section className="py-24 md:py-32 bg-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-20 max-w-4xl mx-auto">
              ...
              <p className="text-lg md:text-xl text-muted-foreground font-light leading-relaxed">Um destino único que combina luxo incomparável, privacidade absoluta e natureza pristine</p>
            </div>
                ...
                <a href="https://instagram.com/followmeviagens" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-slate-300/90 text-xs tracking-wide font-light">
                      Confiado por <span className="text-accent font-semibold">200.000+</span> viajantes
                    </div>
                  </div>
                </a>
              </div>
