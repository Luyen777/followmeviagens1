...
const Inclusions = () => {
  const inclusions = [
    {
      ...
      items: [
        ...
        "Drinks, cervejas, refrigerantes e sucos nos bares",
        "Snacks, sorvetes e petiscos ao longo do dia",
        "Chá da tarde com seleção de quitutes",
        "Minibar abastecido diariamente (água, cerveja, refrigerante)*"
      ]
    },
    {
      category: "Esportes & Atividades",
      items: [
        "Equipamento completo para snorkeling",
        "Esportes aquáticos não motorizados (caiaque, windsurf, SUP)",
        "Bicicletas para explorar toda a ilha",
        "Tênis, squash, badminton, vôlei, futebol de areia",
        "Academia e aulas fitness em grupo (yoga, alongamento)",
        "Piscina adulto e infantil com serviço completo"
      ]
    },
    {
      ...
      items: [
        ...
        "Eventos culturais semanais temáticos",
        "Wi-Fi gratuito nas áreas públicas",
        "Serviço de praia e piscina",
  ...
  const notIncluded = [
    "Transfer de lancha (pago à parte na maioria dos planos)",
    "Mergulho e esportes motorizados",
    "Tratamentos de spa",
    "Excursões e passeios externos",
    "Jantares especiais em restaurantes à la carte",
    "Room service 24h",
    "Bebidas premium e vinhos especiais"
  ];
  ...
  return (
    <section className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        {/* Not Included */}
        <div className="max-w-4xl mx-auto bg-background rounded-2xl p-8 border border-border">
          ...
          <p className="text-xs text-foreground/60 mt-6 pt-6 border-t border-border">
            * Minibar incluído em algumas tarifas específicas. Verifique as condições do seu pacote.
          </p>
        </div>
      </div>
    </section>
