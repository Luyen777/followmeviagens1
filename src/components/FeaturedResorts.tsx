...
const FeaturedResorts = () => {
  const resorts = [{
    ...
    inclusions: ["4 noites em Sunset Lagoon Villa (apartamento duplex)", "Praia privativa e segura ao lado da acomodação", "Todas as refeições inclusas em restaurantes familiares", "Transfers de hidroavião incluídos", "Café da manhã flutuante + cesta de boas-vindas na chegada", "Crianças grátis: desconto para menores de 12, menores de 2 anos grátis", "Amenidades especiais para crianças (brinquedos, jogos, roupões personalizados)", "Bicicletas para toda a família com nomes personalizados", "Equipamento de snorkel para adultos e crianças", "Esportes aquáticos não motorizados para todas as idades", "Atividades exclusivas: manta ray watching, caça ao tesouro e noites de contação de histórias", "Muito mais para toda a família"]
  }, {
    name: "Soneva Jani",
    ...
    inclusions: ["5 noites em Overwater Pool Villa com rede e banheira com vista para o oceano", "Todas as refeições inclusas e bebidas ilimitadas", "Transfers de hidroavião para dois", "Reposição diária de minibar com bebidas", "Aulas de yoga matinais e noturnas", "Chocolate diário para momentos especiais", "Café da manhã flutuante na piscina privativa", "Champagne de boas-vindas", "Massagem para casal", "Jantar romântico à luz de velas na praia", "Experiências exclusivas e inesquecíveis"]
  }, {
    ...
    inclusions: ["5 noites no santuário de Ocean Pool Villa privativo", "Consulta de bem-estar personalizada antes da chegada", "Massagem terapêutica completa Four Pillar Signature", "Terapia aquática (Watsu ou Hammam)", "Sessões de terapia sonora ou AKTAR Mind Therapy", "Yoga, meditação ou pilates diários", "Chás e blends naturais desenvolvidos por especialistas", "Consultas especializadas (Ayurveda, Naturopatia, TCM ou Homeopatia)", "Aulas de culinária e workshops nutricionais", "Tratamentos restauradores de cabelo e couro cabeludo no Flora Lab", "Orientação de bem-estar para continuar saudável em casa"]
  }];
