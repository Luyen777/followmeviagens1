  ...
  return <div className="bg-card border border-border rounded-2xl overflow-hidden hover:shadow-luxury transition-all duration-500 flex flex-col lg:flex-row">
      ...
      <div className="flex-1 order-3 lg:order-1 p-6 sm:p-8">
        ...
        <div className="hidden lg:block mb-4">
          ...
          {description && <p className="text-muted-foreground text-sm leading-relaxed mb-3">
              {description}
            </p>}
        </div>
        ...
        {uniquePerk && <div className="bg-primary/5 border border-primary/20 rounded-xl p-3 mb-4 lg:mb-3">
